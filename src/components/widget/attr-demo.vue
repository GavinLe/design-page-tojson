 <!--编辑器: 在线客服-->
          <div id="tpl_editor_service" v-if="$attrs.curItem.type == 'service'">
              ...
              <form class="am-form tpl-form-line-form">
                  ...
                  <div class="form-items">
                      <draggable :list="curItem.data"
                          ...
                          <div class="form-item" v-for="(banner, index) in curItem.data" :key="index">
          ...
          <div id="tpl_editor_imageSingle" v-if="curItem.type == 'imageSingle'">
              ...
              <form class="am-form tpl-form-line-form">
                  ...
                  <div class="form-items">
                      <draggable :list="curItem.data"
                                  :options="{ animation: 120, filter: 'input', preventOnFilter: false }">
                          <div class="form-item drag" v-for="(imageSingle, index) in curItem.data" :key="index">
                              <i class="iconfont icon-shanchu item-delete"
                                  @click="onEditorDeleleData(index,selectedIndex)"></i>
                              <div class="item-inner">
                                  <div class="am-form-group">
                  ...
                  <div class="j-switch-box" data-item-class="switch-source">
                      ...
                      <div class="switch-source __choice "
                          ...
                          <div class="form-items __goods am-cf">
                              <draggable :list="curItem.data"
                                          :options="{ animation: 120, filter: 'input', preventOnFilter: false }">
                                  <div v-for="(goods,index) in curItem.data" :key="index" class="form-item drag">
                          ...
                          <div class="am-form-group">
                              ...
                              <div class="am-u-sm-8 am-u-end">
                                  <select v-model="curItem.params.auto.category"
                                          data-am-selected="{btnSize: 'sm',  placeholder:'全部分类', maxHeight: 400}">
                                      <option value="0"> -- 全部分类 --</option>
                                      <template v-for="(first, categoryIndex) in opts.catgory">
                                          <option :value="first.category_id" :key="categoryIndex"> {{ first.name }}</option>
                                          <template v-if="first.child">
                                              <option v-for="(two, twoIndex) in first.child" :value="two.category_id" :key="twoIndex">
                                                  　{{ two.name }}
                                              </option>
                                          </template>
                                      </template>
                  ...
                  <div class="j-switch-box" data-item-class="switch-source">
                      ...
                      <div class="switch-source __choice"
                          ...
                          <div class="form-items __goods am-cf">
                              <draggable :list="curItem.data"
                                          :options="{ animation: 120, filter: 'input', preventOnFilter: false }">
                                  <div v-for="(shop, index) in curItem.data" :key="index" class="form-item drag">
                                      <i class="iconfont icon-shanchu item-delete" data-no-confirm="true"
                                          @click="onEditorDeleleData(index, selectedIndex)"></i>
                                      <div class="item-inner">
